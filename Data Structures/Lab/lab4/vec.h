...
//int remove_matching_elements(Vec<class T>& v, T element);
...
template <class T> void Vec<T>::print() const{
  ...
  std::cout << std::endl;
  std::cout << "Size of the whole vector is: " << m_alloc << std::endl;
  std::cout << "Size of the data in the vector is: " << m_size << std::endl;
}
